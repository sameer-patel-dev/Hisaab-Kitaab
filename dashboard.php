...
if (!isset($_SESSION["Username"])) {
	header("location:".DOMAIN."/Elements/login/login.php");
}
			...
			<div class="col-md-4">
				<div class="card mx-auto">
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text"><i class="fa fa-user">&nbsp;</i><i><?php echo $_SESSION["Username"]; ?></i></p>
				    <!-- <p class="card-text"><i class="fa fa-user">&nbsp;</i>Admin</p> -->
				    <!-- <p class="card-text">Last Login : <?php echo $_SESSION["lastlogin"]; ?></p> -->
				...
				<div class="card mx-auto">
				  <div class="card-body">
				    <h4 class="card-title">Upload Handwritten bills</h4>
				    <a href="./include/email.php" class="btn btn-primary">Upload Bills</a>
				  </div>
				</div>
			</div>
			<div class="col-md-8">
						...
						<div class="col-sm-6">
							<div class="card">
						      <div class="card-body">
						        ...
						        <p class="card-text">Here you can view past invoices</p>
						        <a href="view_order.php" class="btn btn-primary">View Orders</a>
						      </div>
						    </div>
						</div>
					</div>
