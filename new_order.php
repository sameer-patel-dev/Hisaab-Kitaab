	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 mx-auto">
				<div class="card" style="box-shadow:0 0 25px 0 lightgrey;">
				  ...
				  <div class="card-body">
				  	<form id="get_order_data" onsubmit="return" method="post" action="try.php">
		...
		<!--<tr>
		    ...
		    <td>Rs.1540</td>
                    ...
                    <center>
                    	<input type="submit" id="print_invoice" style="width:150px;" class="btn btn-success" value="Store bill" name="StoreBill"><br/><br/>
                      	<input type="submit" id="order_form" style="width:150px;" class="btn btn-info" value="Print Invoice" name="PrintInvoice">
                    </center>
